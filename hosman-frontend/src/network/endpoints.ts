// Auth
export const ENDPOINT_ADMIN_LOGIN = '/api/admin-auth/v1/admin-login';
...
// Seller Onboarding
export const ENDPOINT_SELLER_ONBOARDING_REGISTRATION = '/api/seller-onboarding/v1/registration';
